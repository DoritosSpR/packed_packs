...
public class ScreenEvent {
    ...
    abstract static class PhasedMenu<P extends Enum<P>> extends ScreenEvent {
        ...
        public void add(P phase, Component text, ResourceLocation sprite, Runnable onClick) {
        ...
        public void addParent(P phase, Component text, ResourceLocation sprite, Consumer<CtxMenu> onCreateChildren) {
